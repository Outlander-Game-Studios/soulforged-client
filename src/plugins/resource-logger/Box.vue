<template>
  <HorizontalCenter>
    <Container>
      ...
      <!--Should add some indicator if resources/inventory not loaded... but of well for now. -->
      <Spaced>
        <Button @click="ButtonClick()"> Copy To Clipboard </Button>
      </Spaced>
    </Container>
  </HorizontalCenter>
</template>
