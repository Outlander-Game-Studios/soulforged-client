...
const factory = (onCreated = () => {}, operationMod = {}, onDestroyed, onMounted = () => {}) =>
  mockComponent(
    {
      components: {
        OperationCombat,
...
export const manyVsMany = factory(() => {
  storyMocks.modifyEntity('combat', {
    creatures: [
      ...Array.create(5).map(() => storyMocks.cloneEntityPayloadId('mainEntity', extrasInCombat)),
      ...Array.create(30).map(() => storyMocks.cloneEntityPayloadId('mob1', extrasInCombat)),
    ],
  })
})
